...
http://eusebe.github.com/ascii[ascii] is a R package for writing http://www.methods.co.nz/asciidoc/[asciidoc], http://txt2tags.sourceforge.net/[txt2tags], http://docutils.sourceforge.net/rest.html[reStructuredText], http://orgmode.org/[org] or http://textile.thresholdstate.com/[textile] documents with embeded R code.
...
* several Sweave drivers: +RweaveAsciidoc()+, +RweaveT2t()+, +RweaveReST()+, +RweaveOrg()+ and +RweaveTextile()+. 
* some simple wrappers for +Sweave("yourfile.Rnw", RweaveXxx)+ named +Asciidoc()+, +T2t()+, +ReST()+, +Org()+ and +Textile()+.
...
| tgroup                                                                                                                                                                                    | [green]#yes#                    | [green]#yes#                      | [green]#yes#                                         | [red]#no#    |
| n.tgroup                                                                                                                                                                                  | [green]#yes#                    | [green]#yes#                      | [green]#yes#                                         | [red]#no#    |
| talign                                                                                                                                                                                    | [green]#yes#                    | [green]#yes#                      | [red]#no#                                            | [red]#no#    |
| tvalign                                                                                                                                                                                   | [green]#yes#                    | [red]#no#                         | [red]#no#                                            | [red]#no#    |
| tstyle                                                                                                                                                                                    | [green]#yes#                    | [green]#yes#                      | [green]#yes#                                         | [red]#no#    |
| bgroup                                                                                                                                                                                    | [green]#yes#                    | [red]#no#                         | [green]#yes#                                         | [red]#no#    |
| n.bgroup                                                                                                                                                                                  | [green]#yes#                    | [red]#no#                         | [green]#yes#                                         | [red]#no#    |
| balign                                                                                                                                                                                    | [green]#yes#                    | [red]#no#                         | [red]#no#                                            | [red]#no#    |
| bvalign                                                                                                                                                                                   | [green]#yes#                    | [red]#no#                         | [red]#no#                                            | [red]#no#    |
| bstyle                                                                                                                                                                                    | [green]#yes#                    | [red]#no#                         | [green]#yes#                                         | [red]#no#    |
| lgroup                                                                                                                                                                                    | [green]#yes#                    | [red]#no#                         | [green]#yes#                                         | [red]#no#    |
| n.lgroup                                                                                                                                                                                  | [green]#yes#                    | [red]#no#                         | [green]#yes#                                         | [red]#no#    |
| lalign                                                                                                                                                                                    | [green]#yes#                    | [red]#no#                         | [red]#no#                                            | [red]#no#    |
| lvalign                                                                                                                                                                                   | [green]#yes#                    | [red]#no#                         | [red]#no#                                            | [red]#no#    |
| lstyle                                                                                                                                                                                    | [green]#yes#                    | [red]#no#                         | [green]#yes#                                         | [red]#no#    |
...
<<sessionInfo2,echo=FALSE,results=ascii>>=
ascii(sessionInfo())
@
...
<<matrix>>=
ascii(VADeaths, include.rownames = T, include.colnames = T, caption = "VADeaths", header = T, col.width = c(1, 2, 2, 2, 2, 2), valign = "middle", align = c("l", "r", "r", "r", "r"), frame = "topbot")
@
...
ascii(toto[, -1], lgroup = paste("Treatment:", as.character(unique(toto[, 1]))), n.lgroup = c(table(toto[, 1])), rstyle = "s", lvalign = "middle", include.rownames = F)
@ 
...
ff_d <- melt(french_fries, id=1:4, na.rm=TRUE)
toto <- cast(ff_d, treatment + subject ~ variable, mean, margins="treatment")
ascii(toto[, -1], lgroup = paste("Treatment:", as.character(unique(toto[, 1]))), n.lgroup = c(table(toto[, 1])), lstyle = "s", lvalign = "middle", include.rownames = F)
@ 
...
<<labeledlist2,echo=FALSE,results=ascii>>=
ascii(version)
@
...
<<describe2, echo=FALSE,results=ascii>>=
library(Hmisc)
ascii(describe(esoph))
@
...
<<CrossTable>>=
library(descr)
ascii(CrossTable(warpbreaks$wool, warpbreaks$tension, dnn = c("Wool", "Tension")))
@

<<CrossTable2,echo=FALSE,results=ascii>>=
library(descr)
ascii(CrossTable(warpbreaks$wool, warpbreaks$tension, dnn = c("Wool", "Tension")))
@
...
* http://eusebe.github.com/ascii/rest.html[with reStructuredText]
...
or
rst2html-highlight --stylesheet-path=pygments-default.css -s rest.rst rest.html
or
...
docutils and reStructuredText:: http://docutils.sourceforge.net/
...
- http://learnr.wordpress.com/[This blog] uses http://eusebe.github.com/ascii[+ascii+] and http://srackham.wordpress.com/blogpost1/[blogpost] to generate and publish post.
  - http://www.sigmafield.org/[This blog] too but with http://www.sigmafield.org/2009/09/20/welcome-to-sigmafield/[another method].
