...
http://eusebe.github.com/ascii[ascii] is a R package for writing http://www.methods.co.nz/asciidoc/[asciidoc], http://txt2tags.sourceforge.net/[txt2tags], http://docutils.sourceforge.net/rest.html[reStructuredText] or http://orgmode.org/[org] documents with embeded R code.
...
* several Sweave drivers: +RweaveAsciidoc()+, +RweaveT2t()+, +RweaveReST()+ and +RweaveOrg()+. 
* some simple wrappers for +Sweave("yourfile.Rnw", RweaveXxx)+ named +Asciidoc()+, +T2t()+, +ReST()+ and +Org()+.
