...
cacheSweavePandoc <- function()
{
    ...
    list(setup = cacheSweavePandocSetup,
         runcode = cacheSweavePandocRuncode,
...
##' @keywords internal 
##' @author David Hajage
makeCacheRweavePandocCodeRunner <- function(evalFunc=RweaveEvalWithOpt)
{
...
##'
##' @author David Hajage
cacheSweavePandocRuncode <- makeCacheRweavePandocCodeRunner()
