cacheRweaveTextile <- function()
{
    require(cacheSweave)
    list(setup = cacheRweaveTextileSetup,
         runcode = cacheRweaveTextileRuncode,
         writedoc = RweaveTextileWritedoc,
         finish = RweaveTextileFinish,
         checkopts = RweaveTextileOptions)
}

cacheRweaveTextileSetup <-
...
cacheRweaveTextileRuncode <- makeCacheRweaveTextileCodeRunner()
