...
asciiTable <- proto(expr = {
  ...
  show.t2t <- function(.) {
    show.t2t.table(x = .$x, include.rownames = .$include.rownames, include.colnames = .$include.colnames, rownames = .$rownames, colnames = .$colnames, format = .$format, digits = .$digits, decimal.mark = .$decimal.mark, na.print = .$na.print, caption = .$caption, caption.level = .$caption.level, width = .$width, frame = .$frame, grid = .$grid, valign = .$valign, header = .$header, footer = .$footer, align = .$align, style = .$style, lgroup = .$lgroup, n.lgroup = .$n.lgroup, lalign = .$lalign, lvalign = .$lvalign, lstyle = .$lstyle, rgroup = .$rgroup, n.rgroup = .$n.rgroup, ralign = .$ralign, rvalign = .$rvalign, rstyle = .$rstyle, tgroup = .$tgroup, n.tgroup = .$n.tgroup, talign = .$talign, tvalign = .$tvalign, tstyle = .$tstyle, bgroup = .$bgroup, n.bgroup = .$n.bgroup, balign = .$balign, bvalign = .$bvalign, bstyle = .$bstyle)
  }
