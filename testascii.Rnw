...
<<results=ascii>>=
ascii.data.frame(esoph, cgroup = c("Major 1", "Major 2"), n.cgroup = c(2, 3), include.rownames = F)
@ 

<<results=ascii>>=
ascii.data.frame(esoph, cgroup = c("", "Major 1", "Major 2"), n.cgroup = c(1, 2, 3), rgroup = c("", "Minor 1", "Minor 2"), n.rgroup = c(1, 33, 55), include.rownames = F, frame = "topbot", grid = "none")
@ 

<<results=ascii>>=
ascii.data.frame(esoph, cgroup = c("", "Major 1", "Major 2"), n.cgroup = c(1, 2, 3), calign = "r", cstyle = "e", rgroup = c("", "Minor 1", "Minor 2"), n.rgroup = c(1, 33, 55), rvalign = "middle", rstyle = "s", include.rownames = F, frame = "topbot", align = "lr")
@ 
