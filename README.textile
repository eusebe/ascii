...
ascii is (will be…) an R package that converts common R objects to asciidoc or txt2tags syntax.
...
For now, manually download all files... and see http://eusebe.github.com/ascii
