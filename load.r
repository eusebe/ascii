...
source("~/Programmes/fonctionsR/r2asciidoc/print.r")
#source("~/Programmes/fonctionsR/r2asciidoc/set.r")
...
source("~/Programmes/fonctionsR/r2asciidoc/asciiHtest.r")
source("~/Programmes/fonctionsR/r2asciidoc/asciiEpicalc.r")
